...
\begin{DoxyCode}
295                                                          \{
296     printk(KERN\_INFO \textcolor{stringliteral}{"hd44780: device opened from user\(\backslash\)n"});
297 
298     \hyperlink{hd44780_8c_afd20d9c5f02b616c3c3cb41892e3f5d3}{dev\_cnt}++;   \textcolor{comment}{//increment counter }
299 
...
\begin{DoxyCode}
310                                                             \{
311     printk(KERN\_INFO \textcolor{stringliteral}{"hd44780: device closed from user\(\backslash\)n"});
312 
313     \hyperlink{hd44780_8c_afd20d9c5f02b616c3c3cb41892e3f5d3}{dev\_cnt}--;   \textcolor{comment}{//decrement counter}
314 
...
328                                                                                                     \{
329 
330     \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} not\_copied; 
331     \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} to\_copy;
332     \textcolor{keywordtype}{int} i;
333 
334     \textcolor{keywordtype}{char} msg\_from\_user[128] = \{ 0 \};
335 
336     to\_copy = min(cnt, \textcolor{keyword}{sizeof}(\hyperlink{hd44780_8c_a21566485093f5feef65ee0fc7a32a91e}{textbuffer}));
337     not\_copied = copy\_from\_user(\hyperlink{hd44780_8c_a21566485093f5feef65ee0fc7a32a91e}{textbuffer}, user, to\_copy);
338 
339     \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0x80);        \textcolor{comment}{//set cursor to begin}
340 
341     \textcolor{keywordflow}{for}(i = 0; i < to\_copy && \hyperlink{hd44780_8c_a21566485093f5feef65ee0fc7a32a91e}{textbuffer}[i]; i++)\{
342         \textcolor{keywordflow}{if}(isprint(textbuffer[i]))\{         \textcolor{comment}{//checks, whether the passed character is printable }
343             \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(1, textbuffer[i]);
344         \}
345         \textcolor{keywordflow}{if}( i == 15)\{
346             \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0xc0);            \textcolor{comment}{//jump to second row of display}
347         \}
348     \}
349 
350     \textcolor{keywordflow}{if}(copy\_from\_user(msg\_from\_user, user, cnt)) \{
351         printk(\textcolor{stringliteral}{"failed copy from user"});
352     \}
353 \textcolor{keywordflow}{return} to\_copy-not\_copied;              \textcolor{comment}{//returns how many characters are left -> returns 0 if everything
       is copied properly }
354 \}
\end{DoxyCode}
...
\begin{DoxyCode}
277                              \{
278     printk(\textcolor{stringliteral}{"exit display called\(\backslash\)n"});
279     gpio\_free(25);
280     gpio\_free(24);
281     gpio\_free(23);
282     gpio\_free(18);
...
194                                       \{
195     
196     \textcolor{keywordtype}{char} gpio\_name[12];
197     \textcolor{keywordtype}{int} err = 0;
198 
199     snprintf( gpio\_name, \textcolor{keyword}{sizeof}(gpio\_name), \textcolor{stringliteral}{"rpi-gpio-%d"}, nr);
200     err = gpio\_request(nr, gpio\_name);
201 
202     \textcolor{keywordflow}{if}(err)\{
203         printk(\textcolor{stringliteral}{"gpio request for %s failed with %d\(\backslash\)n"}, gpio\_name, err);
204         \textcolor{keywordflow}{return} err;
205     \}
206     err = gpio\_direction\_output(nr, 0);
207     \textcolor{keywordflow}{if}(err)\{
208         printk(\textcolor{stringliteral}{"gpio direction output failed %d\(\backslash\)n"}, err);
209         gpio\_free(nr);
210         \textcolor{keywordflow}{return} err;
211     \}
...
222                              \{
223 
224 printk(\textcolor{stringliteral}{"initialize display\(\backslash\)n"});
225 
226 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(7) == -1)\{
227      \textcolor{keywordflow}{return} -EIO;
228 \}
229 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(8) == -1)\{
230     \textcolor{keywordflow}{goto} free7;
231 \}
232 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(18) == -1)\{
233     \textcolor{keywordflow}{goto} free8;
234 \}
235 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(23) == -1)\{
236     \textcolor{keywordflow}{goto} free18;
237 \}
238 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(24) == -1)\{
239     \textcolor{keywordflow}{goto} free23;
240 \}
241 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_abedd5fbc5004aefc727091a522a79391}{gpio\_request\_output}(25) == -1)\{
242     \textcolor{keywordflow}{goto} free24;
243 \}
244 
245 msleep(15);
246 \hyperlink{hd44780_8c_a0eab6f129d21added23841a39571dea3}{write\_nibble}(0, 0x3);
247 msleep(5);
...
251 msleep(5);
252 \hyperlink{hd44780_8c_a0eab6f129d21added23841a39571dea3}{write\_nibble}(0, 0x2);
253 msleep(5);
254 \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0x28);    \textcolor{comment}{//Command: 4-Bit Mode, 2 lines}
255 msleep(2);
256 \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0x01);
257 msleep(2);
258 
259 \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0x0c);     \textcolor{comment}{//display on, cursor off, blink off}
260 \hyperlink{hd44780_8c_ae0b6133b70bc190065133c49eb16f55f}{write\_lcd}(0, 0xc0);
261     \textcolor{keywordflow}{return} 0;
262 
263 free24: gpio\_free(24);
264 free23: gpio\_free(23);
265 free18: gpio\_free(18);
266 free8: gpio\_free(8);
267 free7: gpio\_free(7);
268     \textcolor{keywordflow}{return} -EIO;
269 \}
\end{DoxyCode}
...
\begin{DoxyCode}
421                                  \{
422     dev\_info(\hyperlink{hd44780_8c_a7f39d148808b935cc26697ba64f38127}{hd44780\_dev}, \textcolor{stringliteral}{"mod\_exit called\(\backslash\)n"});
423     \hyperlink{hd44780_8c_aaeb9d01b89561b7086b450105ecd32fe}{exit\_display}();
424     device\_destroy(\hyperlink{hd44780_8c_a2924ecef65e0b40dc3dfab97f5a18b2f}{hd44780\_class}, \hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev});
425     class\_destroy(\hyperlink{hd44780_8c_a2924ecef65e0b40dc3dfab97f5a18b2f}{hd44780\_class});
426     cdev\_del(\hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object});
427     unregister\_chrdev\_region(\hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev}, 1);
...
\begin{DoxyCode}
365                                 \{
366 \textcolor{keywordtype}{int} error = 0;  
367 
368 \hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev} = MKDEV(\hyperlink{hd44780_8c_ac8947941479c38403a09c14a60b03f01}{major}, \hyperlink{hd44780_8c_aec7b96885baf2e6f10efbdef9d935a0b}{minor});
369 
370 \textcolor{keywordflow}{if}(register\_chrdev\_region(MKDEV(\hyperlink{hd44780_8c_ac8947941479c38403a09c14a60b03f01}{major}, 0),\hyperlink{hd44780_8c_ad43c3812e6d13e0518d9f8b8f463ffcf}{count},\textcolor{stringliteral}{"hd44780"}) < 0)\{
371     printk(\textcolor{stringliteral}{"devicenumber(255, 0) in use!\(\backslash\)n"});
372     \textcolor{keywordflow}{return} -EIO;
373 \}
374 \textcolor{keywordflow}{else}\{
375     error = alloc\_chrdev\_region(&\hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev}, 0, \hyperlink{hd44780_8c_ad43c3812e6d13e0518d9f8b8f463ffcf}{count}, \textcolor{stringliteral}{"hd44780"});
376     \hyperlink{hd44780_8c_ac8947941479c38403a09c14a60b03f01}{major} = MAJOR(\hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev});
377 \}
378 
379 \hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object} = cdev\_alloc();  \textcolor{comment}{/* registered object reserved*/}
380 
381 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object} == NULL)\{
382     \textcolor{keywordflow}{goto} free\_device\_number;
383 \}
384 
385 \hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object}->owner = THIS\_MODULE;
386 \hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object}->ops = &\hyperlink{hd44780_8c_a28ee7ed9613033920e733c9da671f79c}{fops};
387     
388 \textcolor{keywordflow}{if}(cdev\_add(\hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object}, \hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev}, 1))\{
389     \textcolor{keywordflow}{goto} free\_cdev;
390 \}
391 
392 \hyperlink{hd44780_8c_a2924ecef65e0b40dc3dfab97f5a18b2f}{hd44780\_class} = class\_create(THIS\_MODULE, \textcolor{stringliteral}{"hd44780"});
393 
394 \textcolor{keywordflow}{if}(IS\_ERR(\hyperlink{hd44780_8c_a2924ecef65e0b40dc3dfab97f5a18b2f}{hd44780\_class}))\{
395     pr\_err(\textcolor{stringliteral}{"hd44780: no udev support!\(\backslash\)n"});
396     \textcolor{keywordflow}{goto} free\_cdev;
397 \}
398 
399 \hyperlink{hd44780_8c_a7f39d148808b935cc26697ba64f38127}{hd44780\_dev} = device\_create(\hyperlink{hd44780_8c_a2924ecef65e0b40dc3dfab97f5a18b2f}{hd44780\_class}, NULL, \hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev}, NULL, \textcolor{stringliteral}{"%s"}, \textcolor{stringliteral}{"hd44780"});
400 dev\_info(\hyperlink{hd44780_8c_a7f39d148808b935cc26697ba64f38127}{hd44780\_dev}, \textcolor{stringliteral}{"mod\_init called\(\backslash\)n"});
401 
402 \textcolor{keywordflow}{if}(\hyperlink{hd44780_8c_a56a4067c846fe4fc7959a60d87b8b0f1}{init\_display}() == 0)\{
403     \textcolor{keywordflow}{return} 0;
404 \}
405 
406 free\_cdev:
407     kobject\_put(&\hyperlink{hd44780_8c_a628c122c638ae60b0c6d8a30c4e55b46}{driver\_object}->kobj);
408 free\_device\_number:
409     unregister\_chrdev\_region(\hyperlink{hd44780_8c_a8910285a0352a5c710e65ec9ecbe32a1}{dev}, 1);
410     printk(\textcolor{stringliteral}{"mod\_init failed\(\backslash\)n"});
411     \textcolor{keywordflow}{return} -EIO;
412 \}
\end{DoxyCode}
...
\begin{DoxyCode}
183                                             \{
184     \hyperlink{hd44780_8c_a0eab6f129d21added23841a39571dea3}{write\_nibble}(regist, value >> 4); \textcolor{comment}{//HIGH-Nibble logic}
185     \hyperlink{hd44780_8c_a0eab6f129d21added23841a39571dea3}{write\_nibble}(regist, value & 0xf); \textcolor{comment}{//LOW-Nibble logic}
186 \}
\end{DoxyCode}
...
161                                                \{
162 
163     gpio\_set\_value(7, regist);
164     
165     gpio\_set\_value(25, value & 0x1); \textcolor{comment}{//DATABIT 4}
166     gpio\_set\_value(24, value & 0x2); \textcolor{comment}{//DATABIT 5}
167     gpio\_set\_value(23, value & 0x4); \textcolor{comment}{//DATABIT 6}
168     gpio\_set\_value(18, value & 0x8); \textcolor{comment}{//DATABIT 7}
169 
170     gpio\_set\_value(8, 1); \textcolor{comment}{//enabled to write values}
171     
172     udelay(40);
173 
174     gpio\_set\_value(8, 0); \textcolor{comment}{//disabled to write values}
175 \}
\end{DoxyCode}
